...
public class HapusProdukInternal extends JInternalFrame {



    public HapusProdukInternal() {
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        btnHapusSemua.setText("Hapus SEMUA Data Produk");
    ...
    private void hapusSatu() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "Hapus produk \"" + selected + "\"?",
                "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);
        if (confirm != JOptionPane.YES_OPTION) return;

        try (Connection conn = DBConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement("DELETE FROM produk WHERE id_produk=?")) {
            ps.setString(1, id);
            ps.executeUpdate();
    ...
    private void hapusSemua() {
        int confirm = JOptionPane.showConfirmDialog(this,
                "Anda akan menghapus SEMUA data produk. Lanjutkan?",
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            st.executeUpdate("DELETE FROM produk");
            JOptionPane.showMessageDialog(this, "Seluruh data produk berhasil dihapus.");
            loadIds();
        } catch (SQLException ex) {
