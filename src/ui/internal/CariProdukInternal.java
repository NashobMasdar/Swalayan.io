...
public class CariProdukInternal extends JInternalFrame {


    private javax.swing.table.DefaultTableModel model;


    public CariProdukInternal() {
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        txtCariLbl.setText("Cari (ID/Nama Produk):");
        btnCari.setText("Cari");
        btnSemua.setText("Tampilkan Semua");
        model = new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] {"ID Produk", "Nama Produk", "Jenis", "Stok", "Harga"}) {
    ...
    private void loadData(String keyword) {
        model.setRowCount(0);
        String sql = "SELECT id_produk, nama_produk, jenis_produk, stok_produk, harga_produk FROM produk "
                + "WHERE id_produk LIKE ? OR nama_produk LIKE ? ORDER BY id_produk";
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    model.addRow(new Object[]{
                            rs.getString("id_produk"), rs.getString("nama_produk"),
                            rs.getString("jenis_produk"), rs.getInt("stok_produk"),
